  ...
  return (
    <div>
      ...
      <svg viewBox="0 0 1200 160" className="w-full h-auto" style={{ display: 'block' }}>
        ...
        <text x="180" y="75" fontFamily="sans-serif" fontSize="42" fontWeight="bold" fill="#ffffff">
          LastSeeds
        </text>
        <text x="180" y="105" fontFamily="sans-serif" fontSize="16" fill="#8896ab">
          De kluis voor wat overblijft
        </text>

        {/* decoratieve stippen/lijnen, post-apocalyptisch thema */}
