    ...
    <div>
          ...
          <div className="flex items-center gap-4">
            {loaded && user ? (
              <>
                ...
                <Link href="/dashboard/favorites" className="text-gray-300 hover:text-white">Favorieten</Link>
      ...
      <svg viewBox="0 0 1200 160" className="w-full h-auto" style={{ display: 'block' }}>
        ...
        <g transform="translate(85,55)">
          ...
          <ellipse cx="0" cy="45" rx="9" ry="13" fill="none" stroke="#8896ab" strokeWidth="2.5" transform="rotate(-15 0 45)" />

          {/* Zaadje 2 (midden, gewoon zaadje) */}
          <ellipse cx="20" cy="50" rx="9" ry="13" fill="none" stroke="#8896ab" strokeWidth="2.5" transform="rotate(10 20 50)" />

          {/* Zaadje 3 (rechts) met ontkiemend steeltje en blaadjes */}
          <ellipse cx="42" cy="52" rx="9" ry="13" fill="none" stroke="#4a9eff" strokeWidth="2.5" />
          <path d="M42 39 C42 20, 42 12, 42 2" fill="none" stroke="url(#stemGradient)" strokeWidth="3" strokeLinecap="round" />
          <path d="M42 22 C34 16, 28 18, 24 12 C30 10, 38 12, 42 18 Z" fill="#4a9eff" opacity="0.85" />
          <path d="M42 14 C50 8, 56 10, 60 4 C54 2, 46 4, 42 10 Z" fill="#4a9eff" opacity="0.85" />
        </g>
