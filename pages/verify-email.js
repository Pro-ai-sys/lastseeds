    ...
    <div className="min-h-screen bg-[#060a14] text-white">
      ...
      <div className="flex items-center justify-center px-4 py-24">
        <div className="w-full max-w-md bg-[#101828] border border-[#2a3a55] rounded-2xl p-8 text-center">
          {status === 'loading' && <p className="text-gray-400">Bezig met verifiëren...</p>}
          ...
          {status === 'success' && (
            <>
              ...
              <Link href="/login" className="bg-[#4a9eff] hover:bg-[#3a8eef] px-6 py-2 rounded-lg font-semibold transition inline-block">
                Ga naar inloggen
              </Link>
            </>
          )}
